...
// extern const unsigned char apexEngineFont[];
// extern const unsigned char menufont[];
extern const unsigned int LXGWNeoXiHei_compressed_size;
extern const unsigned int LXGWNeoXiHei_compressed_data[];
