...
enum weapon_id : int32_t {
  ...
  idweapon_havoc = 86,
  idweapon_eva8 = 88,
  idweapon_flatline = 89,
  idweapon_g7_scout = 90,
  idweapon_hemlock = 91,
  idweapon_kraber = 93,
  idweapon_lstar = 94,
  idweapon_mastiff = 96,
  idweapon_mozambique = 97,
  idweapon_prowler = 102,
  idweapon_peacekeeper = 104,
  idweapon_r99 = 105,
  idweapon_p2020 = 106,
  idweapon_spitfire = 107,
  idweapon_triple_take = 108,
  idweapon_wingman = 110,
  idweapon_volt = 111,
  idweapon_3030_repeater = 112,
  idweapon_car_smg = 113,
  idweapon_nemesis = 114,
  idthrowing_knife = 158,
  idgrenade_thermite = 167,
  idgrenade_frag = 168,
  idgrenade_arc_star = 169,
  idmax
};
