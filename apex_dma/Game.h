...
enum weapon_id : int32_t {
    ...
    idweapon_r99 = 110,
    idweapon_p2020 = 111,
    idweapon_spitfire = 112,
    idweapon_triple_take = 113,
    idweapon_wingman = 114,
    idweapon_volt = 116,
    idweapon_3030_repeater = 117,
    idweapon_car_smg = 118,
    idweapon_nemesis = 119,
    idthrowing_knife = 173,
    idgrenade_thermite = 174,
    idgrenade_frag = 175,
    idgrenade_arc_star = 176,
    idmax
};
