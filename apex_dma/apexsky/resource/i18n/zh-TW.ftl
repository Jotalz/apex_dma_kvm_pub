...
title-aim-setting = 瞄準設置 ------ 15
title-extra-skill = 額外能力 ------ 27
title-other-setting = 其他設置 ------ 32
...
menu-item-weapon-predict = 武器預測微調
...
weapon-hop-ups-menu-title = 特殊配件菜單
loot-turbo-charger = 渦輪增壓器(未开放)
loot-skull-piecer = 穿顱者膛線(未开放)
loot-hammer-points = 槌點彈藥
loot-disruptor-rounds = 干擾器(未开放)
