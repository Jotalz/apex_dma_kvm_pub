...
#define OFFSET_CROSSHAIR_LAST 0x1998 //[Miscellaneous].CWeaponX!lastCrosshairTargetTime updated 2024/04/02

#define OFFSET_ITEM_ID 0x1558 //[RecvTable.DT_PropSurvival].m_customScriptInt updated 2/14/2024
...
#define OFFSET_WEAPON_BITFIELD 0x1704 //[RecvTable.DT_WeaponX].m_modBitfieldFromPlayer updated 2024/04/02
...
#define OFFSET_PRIMARY_WEAPON 0x1934 //[RecvTable.DT_BaseCombatCharacter].m_latestPrimaryWeapons updated 2024/04/02
#define OFFSET_GRAPPLE_ATTACHED 0x0048 //[RecvTable.DT_GrappleData].m_grappleAttached updated 2024/04/02
...
#define OFFSET_M_CUSTOMSCRIPTINT 0x1558 //[RecvTable.DT_PropSurvival].m_customScriptInt updated 2024/04/02
...
#define OFFSET_PLATFORM_UID 0x2548 //[RecvTable.DT_Player].m_platformUserId updated 2024/04/02
#define OFFSET_SKYDRIVESTATE 0x468c //[RecvTable.DT_Player].m_skydiveState updated 2024/04/02
#define OFFSET_GRAPPLE 0x2c40 //[RecvTable.DT_Player].m_grapple updated 2024/04/02
#define OFFSET_GRAPPLE_ACTIVE 0x2cd0 //[RecvTable.DT_Player].m_grappleActive updated 2024/04/02
...
#define OFFSET_VIEW_MODELS 0x2d18 //[RecvTable.DT_Player].m_hViewModels updated 2024/04/02
...
#define OFFSET_WALLRUNSTART 0x3584 //[DataMap.C_Player].m_wallRunStartTime updated 2024/04/02
#define OFFSET_WALLRUNCLEAR 0x3588 //[DataMap.C_Player].m_wallRunClearTime float updated 2024/04/02
...
#define OFFSET_IN_BACKWARD 0x073f26f0 //[Buttons].in_backward updated 2024/04/02
...
#define OFFSET_HIGHLIGHTGENERICCONTEXT 0x028d //[RecvTable.DT_HighlightSettings].m_highlightGenericContexts updated 2024/04/02
